...
<title>아이디 찾기</title>
  ...
  <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/membership/id_search.css">
</head>
<body>
      ...
      <div>
          ...
          <div id="red">
            ...
            <div id="password_search">
              <span><a href="./passwordsearch"><b>비밀번호찾기<b></a></span>
  ...
  <script src="<%=request.getContextPath()%>/resources/membershipJS/id_search.js"></script>
</body>
</html>