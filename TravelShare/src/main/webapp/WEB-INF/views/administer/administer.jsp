...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources/css/administer_main.css?ver=1.039">
</head>
<body>
    <section class="admin">
        ...
        <div class="admin_container">
            ...
            <div class="admin_main">
                ...
                <div class="admin_member_container admin_allContainer">
                    ...
                    <table class="admin_member_table" style="text-align: center; border: 1px solid black; width: 800px;">
                        <thead>
                           <tr>
                ...
                <div class="admin_admin_container admin_allContainer">
                    ...
                    <div class="admin_admin_count">
                        관리자 현황
                    </div>
                    <table class="admin_admin_table" style="text-align: center; border: 1px solid black; width: 800px;">
                        <thead>
                           </tr>
                               <th style="background-color: #fafafa; text-align: center;">이름</th>
                               <th style="background-color: #fafafa; text-align: center;">나이</th>
                ...
                <div class="admin_board_container admin_allContainer">
                    ...
                    <div class="admin_board_count">
                        관리자 현황
                    </div>
                    <table class="admin_board_table" style="text-align: center; border: 1px solid black; width: 800px;">
                        <thead>
                           </tr>
                               <th style="background-color: #fafafa; text-align: center;">게시글 번호</th>
                ...
                <div class="admin_declare_container admin_allContainer">
                    ...
                    <table class="admin_declare_table" style="text-align: center; border: 1px solid black; width: 800px;">
                        <thead>
                           </tr>
                           <th style="background-color: #fafafa; text-align: center;">게시글 번호</th>
                           <th style="background-color: #fafafa; text-align: center;">내용</th>
                ...
                <div class="admin_notice_container admin_allContainer">
                    ...
                    <div class="admin_notice_count">
                        공지사항 게시글
                    </div>
                    <table class="admin_notice_table" style="text-align: center; border: 1px solid black; left:0; width: 800px;">
                        <thead>
                           </tr>
                               <th style="background-color: #fafafa; text-align: center;">이름</th>
                               <th style="background-color: #fafafa; text-align: center;">나이</th>
    ...
    <script src="<%=request.getContextPath()%>/resources/js/administer_ajax.js?ver=1.039"></script>
